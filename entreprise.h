...
public:
    ...
    entreprise(int,QString,QString,int);
     ...
     QSqlQuery * getIdEntreprise();
     QSqlQuery * getVoyagesEntreprise(int idEntreprise);
     QSqlQuery * getPromotionEntreprise(int idEntreprise);
        bool ajouter();
        ...
        QSqlQueryModel *recherche_avancee(QString arg, int checkButton);
        QSqlQueryModel *tri_avancee(QString arg);
